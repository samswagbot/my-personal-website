...
import { H2, Anchor, Paragraph, H3, MainContainer } from 'Components/components';
  ...
  return (
    <MainContainer>
      ...
      <TalkDetails>
        ...
        In 2016, I started my medical transition from female to male and I
        decided to share my story with SoulCycle to build strong alliances
        through education. I continue to any oppurtunity to share my experience
        and build trans visability in the workplace.
      </TalkDetails>
      <TalkDetails>
      ...
      <TalkDetails>
        ...
        marketing to influence and particate a Queer and diverse pride campaign.
      </TalkDetails>
      <InstagramEmbed
