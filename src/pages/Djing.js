...
const Djing = () => {
  const firstLibreSet =
    'https://www.mixcloud.com/widget/iframe/?hide_cover=1&feed=%2Fpapisamson%2Ffirst-libre-set%2F';
  const libreNoBarSet =
    'https://www.mixcloud.com/widget/iframe/?hide_cover=1&feed=%2Fpapisamson%2Flibre-no-bar%2F';
  const quarinteaseSet =
    'https://www.mixcloud.com/widget/iframe/?hide_cover=1&feed=%2Fpapisamson%2Fquarintease%2F';
  ...
  return (
    <MainContainer>
      <StyledDJingCtn>
        ...
        <Paragraph>
          I'm a co-founder and dj of a queer collective, a celebration centering
          queer and trans* folx of the diaspora and those who love us. Libre has
          given me the platform to discover and curate music of the world. World
          music is my genre with a heavy influence on Latinx music. Have a
          listen below and check out Libre on{' '}
          <Anchor href={libreHandle} target="_blank">
            Instagram
          </Anchor>{' '}
          or see our party below!
        </Paragraph>
